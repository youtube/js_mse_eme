...
testWidevineSupport.prototype.onsourceopen = function() {
  ...
  if (!StreamDef.isWebM()) {
    this.runner.checkEq(
        ...
        'canPlayType result');
    this.runner.checkEq(
        mightEMETypeBeSupported(video.canPlayType('video/mp4', 'com.widevine.alpha')), 'maybe',
        'canPlayType result');
    this.runner.checkEq(
        video.canPlayType('audio/mp4; codecs="mp4a.40.2"', 'com.widevine.alpha'), 'probably',
        'canPlayType result');
    this.runner.checkEq(
        mightEMETypeBeSupported(video.canPlayType('audio/mp4', 'com.widevine.alpha')), 'maybe',
        'canPlayType result');
    this.runner.succeed();
  } else {
    this.runner.checkEq(
    ...
    this.runner.checkEq(
        ...
        'canPlayType result');
    this.runner.checkEq(
        mightEMETypeBeSupported(video.canPlayType('video/webm', 'com.widevine.alpha')), 'maybe',
        'canPlayType result');
    this.runner.checkEq(
         video.canPlayType('audio/mp4; codecs="mp4a.40.2"', 'com.widevine.alpha'), 'probably',
        'canPlayType result');
