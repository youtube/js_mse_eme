...
testXHRAbort.prototype.start = function(runner, video) {
  ...
  function startXHR(i) {
    var xhr = runner.XHRManager.createRequest(
        Media.H264.VideoNormal.src + '?x=' + Date.now() + '.' + i, function() {
      if (i >= N) {
...
testAddSourceBuffer.prototype.onsourceopen = function() {
  try {
    ...
    this.ms.addSourceBuffer(Media.H264.mimetype);
...
testSourceRemove.prototype.onsourceopen = function() {
  ...
  for (var i = 0; i < 10; ++i) {
    try {
      sb = this.ms.addSourceBuffer(Media.H264.mimetype);
...
testStartPlayWithoutData.prototype.onsourceopen = function() {
  ...
  var videoStream = Media.H264.VideoHuge;
...
testEventTimestamp.prototype.onsourceopen = function() {
  ...
  var videoStream = Media.H264.VideoTiny;
...
createSupportTest(Media.VP9.mimetype, 'VP9', true);
createSupportTest(Media.Opus.mimetype, 'Opus');

var createAppendTest = function(stream, unused_stream, optional) {
  optional = !optional;
...
var createAbortTest = function(stream, unused_stream, optional) {
  optional = !optional;
  var test = createConformanceTest(
...
var createTimestampOffsetTest = function(stream, unused_stream, optional) {
  optional = !optional;
  var test = createConformanceTest(
...
var createDASHLatencyTest = function(videoStream, audioStream, optional) {
  optional = !optional;
  var test = createConformanceTest('DASHLatency' + videoStream.codec,
      'MSE (' + videoStream.codec + ')', optional);
...
var createDurationAfterAppendTest = function(stream, unused_stream, optional) {
  optional = !optional;
  var test = createConformanceTest(
...
var createVideoDimensionTest = function(videoStream, audioStream, optional) {
  optional = !optional;
...
var createPlaybackStateTest = function(stream, optional) {
  optional = !optional;
...
var createPlayPartialSegmentTest = function(stream, optional) {
  optional = !optional;
...
var createIncrementalAudioTest = function(stream) {
  ...
  test.prototype.onsourceopen = function() {
    var runner = this.runner;
    var sb = this.ms.addSourceBuffer(stream.mimetype);
    var unused_sb = this.ms.addSourceBuffer(Media.H264.mimetype);
    var xhr = runner.XHRManager.createRequest(stream.src, function(e) {
      sb.appendBuffer(xhr.getResponseData());
      sb.addEventListener('updateend', function() {
        runner.checkEq(sb.buffered.length, 1, 'Source buffer number');
...
var createAppendVideoOffsetTest = function(stream1, stream2, audioStream, optional) {
  optional = !optional;
...
var createAppendMultipleInitTest = function(stream, unused_stream, optional) {
  optional = !optional;
  var test = createConformanceTest(
...
var createAppendOutOfOrderTest = function(stream, unused_stream, optional) {
  optional = !optional;
  var test = createConformanceTest(
...
var createBufferedRangeTest = function(stream, unused_stream, optional) {
  optional = !optional;
  var test = createConformanceTest(
...
var createMediaSourceDurationTest = function(videoStream, audioStream, optional) {
  optional = !optional;
...
var createOverlapTest = function(stream, unused_stream, optional) {
  optional = !optional;
  var test = createConformanceTest(
...
var createSmallGapTest = function(stream, unused_stream, optional) {
  optional = !optional;
  var test = createConformanceTest(
...
var createLargeGapTest = function(stream, unused_stream, optional) {
  optional = !optional;
  var test = createConformanceTest(
...
var createSeekTest = function(videoStream, optional) {
  optional = !optional;
...
var createBufUnbufSeekTest = function(videoStream, optional) {
  optional = !optional;
...
createAppendMultipleInitTest(Media.Opus.CarLow, Media.H264.Video1MB);
createAppendOutOfOrderTest(Media.Opus.CarMed, Media.H264.Video1MB);
createBufferedRangeTest(Media.Opus.CarMed, Media.H264.Video1MB);
createOverlapTest(Media.Opus.CarMed, Media.H264.Video1MB);
createSmallGapTest(Media.Opus.CarMed, Media.H264.Video1MB);
createLargeGapTest(Media.Opus.CarMed, Media.H264.Video1MB);
createDelayedTest(Media.Opus.CarMed, Media.H264.VideoNormal);
...
createDelayedTest(Media.AAC.AudioNormal, Media.H264.VideoNormal);

// VP9 Specific tests. These tests are optional since VP9 is not required in Operator devices.
createAppendTest(Media.VP9.Video1MB, Media.AAC.Audio1MB, true);
createAbortTest(Media.VP9.Video1MB, Media.AAC.Audio1MB, true);
createTimestampOffsetTest(Media.VP9.Video1MB, Media.AAC.Audio1MB, true);
createDASHLatencyTest(Media.VP9.VideoTiny, Media.AAC.Audio1MB, true);
createDurationAfterAppendTest(Media.VP9.Video1MB, Media.AAC.Audio1MB, true);
createPausedTest(Media.VP9.Video1MB, true);
createVideoDimensionTest(Media.VP9.VideoNormal, Media.AAC.AudioNormal, true);
createPlaybackStateTest(Media.VP9.VideoNormal, true);
createPlayPartialSegmentTest(Media.VP9.VideoTiny, true);
createAppendVideoOffsetTest(Media.VP9.VideoNormal, Media.VP9.VideoTiny,
                            Media.AAC.AudioNormal, true);
createAppendMultipleInitTest(Media.VP9.Video1MB, Media.AAC.Audio1MB, true);
createAppendOutOfOrderTest(Media.VP9.VideoNormal, Media.AAC.AudioNormal, true);
createBufferedRangeTest(Media.VP9.VideoNormal, Media.AAC.AudioNormal, true);
createMediaSourceDurationTest(Media.VP9.VideoNormal, Media.AAC.AudioNormal, true);
createOverlapTest(Media.VP9.VideoNormal, Media.AAC.AudioNormal, true);
createSmallGapTest(Media.VP9.VideoNormal, Media.AAC.AudioNormal, true);
createLargeGapTest(Media.VP9.VideoNormal, Media.AAC.AudioNormal, true);
createSeekTest(Media.VP9.VideoNormal, true);
createBufUnbufSeekTest(Media.VP9.VideoNormal, true);
createDelayedTest(Media.VP9.VideoNormal, Media.AAC.AudioNormal, true);
