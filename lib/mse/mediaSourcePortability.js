...
function setupMsePortability(testSuiteVer) {
  ...
  // If we have both MediaSource and WebKitMediaSource, then it's likely we
  // have Chrome with the dual implementation. Then pick the one that is
  // specified by testSuiteVer.
