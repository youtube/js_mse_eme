...
var StreamDef = (function() {
  ...
  var audioStreamDef = {
    ...
    AudioNormalAdv: [util.getMediaPath('car-20120827-8c.mp4'), 2884572, 181.58, {200000: 12.42}],
  ...
  var videoStreamDef = {
    ...
    VP9: {
      ...
      Streams: {
        ...
        VideoNormal: [util.getMediaPath('feelings_vp9-20130806-243.webm'), 7902885, 135.46, {
