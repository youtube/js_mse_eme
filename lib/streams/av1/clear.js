...
const AV1_STREAMS_CLEAR = {
  ...
  HdrHlg144p: [
    'av1/hdr3_hlg_30fps_144p.mp4', 313183, 35.00, {
      ...
      'codecMetadata': Object.assign({}, AV1Codec.hlgMetadata(), {level: '2.0'}),
    }
  ],
  HdrHlg240p: [
  ...
  HdrHlg360p: [
    'av1/hdr3_hlg_30fps_360p.mp4', 1290043, 35.00, {
      ...
      'resolution': '360p',
      'transferFunction': 'HLG',
      'codecMetadata': Object.assign({}, AV1Codec.hlgMetadata(), {level: '2.1'}),
    }
  ],
  HdrHlg480p: [
    'av1/hdr3_hlg_30fps_480p.mp4', 2177095, 35.00, {
      ...
      'resolution': '480p',
      'transferFunction': 'HLG',
      'codecMetadata': Object.assign({}, AV1Codec.hlgMetadata(), {level: '3.0'}),
    }
  ],
  HdrHlg720p24: [
    'av1/hdr2_hlg_24fps_720p.mp4', 1312552, 29.99, {
      ...
      'resolution': '720p',
      'transferFunction': 'HLG',
      'codecMetadata': Object.assign({}, AV1Codec.hlgMetadata(), {level: '3.1'}),
    }
  ],
  HdrHlg720p60: [
    'av1/hdr3_hlg_60fps_720p.mp4', 4911991, 35.00, {
      ...
      'resolution': '720p',
      'transferFunction': 'HLG',
      'codecMetadata': Object.assign({}, AV1Codec.hlgMetadata(), {level: '4.0'}),
    }
  ],
  HdrHlg1080p24: [
  ...
  HdrHlg1080p60: [
    'av1/hdr3_hlg_60fps_1080p.mp4', 8570043, 35.00, {
      ...
      'resolution': '1080p',
      'transferFunction': 'HLG',
      'codecMetadata': Object.assign({}, AV1Codec.hlgMetadata(), {level: '4.1'}),
    }
  ],
  HdrHlg1440p24: [
    'av1/hdr2_hlg_24fps_2k.mp4', 7382834, 29.99, {
      ...
      'resolution': '1440p',
      'transferFunction': 'HLG',
      'codecMetadata': Object.assign({}, AV1Codec.hlgMetadata(), {level: '5.0'}),
    }
  ],
  HdrHlg1440p60: [
  ...
  HdrHlg2160p60: [
    'av1/hdr3_hlg_60fps_4k.mp4', 51335401, 35.00, {
      ...
      'resolution': '2160p',
      'transferFunction': 'HLG',
      'codecMetadata': Object.assign({}, AV1Codec.hlgMetadata(), {level: '5.1'}),
    }
  ],
  HdrPq144p: [
