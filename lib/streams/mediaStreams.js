...
var Media = (function() {
  ...
  var AV1 = {
    ...
    streams: {
      ...
      Bunny144p30fps: [
        'big-buck-bunny-av1-144p-30fps.mp4', 5893473, 634.60,
        {
          'fps': 30,
          'resolution': '144p',
          'mimeType': `video/mp4; codecs="${util.av1Codec('2.0')}"`,
      ...
      Bunny240p30fps: [
        'big-buck-bunny-av1-240p-30fps.mp4', 11503768, 634.60,
        {
          'fps': 30,
          'resolution': '240p',
          'mimeType': `video/mp4; codecs="${util.av1Codec('2.0')}"`,
          'videoChangeRate': 26.67,
        }
      ],
      Bunny360p30fps: [
        'big-buck-bunny-av1-360p-30fps.mp4', 20994433, 634.60,
        {
          'fps': 30,
          'resolution': '360p',
      ...
      Bunny480p30fps: [
        'big-buck-bunny-av1-480p-30fps.mp4', 37354431, 634.60,
        {
          'fps': 30,
          'resolution': '480p',
      ...
      Bunny720p30fps: [
        'big-buck-bunny-av1-720p-30fps.mp4', 75316857, 634.60,
        {
          'fps': 30,
          'resolution': '720p',
      ...
      Bunny720p60fps: [
        'big-buck-bunny-av1-720p-60fps.mp4', 83414881, 634.57,
        {
          'fps': 60,
          'resolution': '720p',
      ...
      Bunny1080p30fps: [
        'big-buck-bunny-av1-1080p-30fps.mp4', 133316322, 634.60,
        {
          'fps': 30,
          'resolution': '1080p',
          'mimeType': `video/mp4; codecs="${util.av1Codec('4.0')}"`,
      ...
      Bunny1080p60fps: [
        'big-buck-bunny-av1-1080p-60fps.mp4', 139409696, 634.57,
        {
          'fps': 60,
          'resolution': '1080p',
      ...
      Bunny1440p30fps: [
        'big-buck-bunny-av1-1440p-30fps.mp4', 386158447, 624.00,
        {
          'fps': 30,
          'resolution': '1440p',
      ...
      Bunny1440p60fps: [
        'big-buck-bunny-av1-1440p-60fps.mp4', 243254027, 334.40,
        {
          'fps': 60,
          'resolution': '1440p',
          'mimeType': `video/mp4; codecs="${util.av1Codec('5.0')}"`,
      ...
      Bunny2160p30fps: [
        'big-buck-bunny-av1-2160p-30fps.mp4', 259954690, 202.67,
        {
          'fps': 30,
          'resolution': '2160p',
          'mimeType': `video/mp4; codecs="${util.av1Codec('5.0')}"`,
      ...
      Bunny2160p60fps: [
        'big-buck-bunny-av1-2160p-60fps.mp4', 166423739, 116.53,
        {
          'fps': 60,
          'resolution': '2160p',
          'mimeType': `video/mp4; codecs="${util.av1Codec('5.1')}"`,
        }
      ],
    },
  };
