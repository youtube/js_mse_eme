...
EMEHandler.prototype.init = function(video, licenseManager) {
  ...
  this.serverCertificateRequest = false;
...
EMEHandler.prototype.onMessage = function(event) {
  ...
  this.IsSetServerCertificateRequest(message);
 ...
 */
EMEHandler.prototype.IsSetServerCertificateRequest = function(message) {
  dlog(2, 'IsSetServerCertificateRequest()');
  var msg = proto.yts_eme.Message.deserializeBinary(message);
  if (msg.getId() == 4) {
    this.serverCertificateRequest = true;
  }
}
